...
import EventCard from "../components/EvectsCards";
  ...
  useEffect(() => {
    ...
    if (sortBy) {
      result = result.sort((a, b) => {
        switch (sortBy) {
          case 'date':
            return new Date(a.dateRange.split('-')[0]) - new Date(b.dateRange.split('-')[0]);
          case 'price':
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-center text-gray-600 mb-8">You can see all events here</p>
