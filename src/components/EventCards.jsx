      ...
      <div className="relative p-4">
        ...
        <div className="flex items-center justify-between">
         ...
         <span className="mb-3 text-xl font-bold text-orange-400">{price}</span>
          ...
          <button className="w-full mt-5 rounded bg-black font-bold py-2 text-white hover:bg-orange-400 hover:text-black transition-colors focus:outline-none focus:ring-2 focus:ring-black focus:ring-opacity-50">
            Explore Event
          </button>
        </div>
      </div>
