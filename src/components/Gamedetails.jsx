      ...
      <main className="mx-auto md:px-28 px-4">
        ...
        <div className="relative pt-4">
          ...
          <div className="h-[70px] flex items-center md:justify-center justify-start pl-2 md:pl-0 relative bg-[#393939] mt-[20px] rounded-[10px]">
            ...
            <button
              ...
              className="absolute right-3 bg-[#FFCD5A] p-3 rounded-[20px] text-black text-[10px] md:text-[14px] font-bold"
            >
              Buy Ticket →
            </button>
          </div>
        ...
        <section className="mt-8 p-6 rounded-[30px] shadow-md border-[#393939] border-4">
          ...
          <div className="text-center mt-6">
            <button
              onClick={handleCheckout}
              className="bg-[#FFCD5A] text-black px-6 py-2 rounded-lg font-bold shadow-lg hover:bg-yellow-400"
            >
              Checkout
            </button>
          </div>
